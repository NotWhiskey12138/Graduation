...
public class PlayerLedgeClimbState : PlayerState
{
    ...
    private void CheckForSpace()
    {
        isTouchingCeiling =
            Physics2D.Raycast(
                cornerPos + (Vector2.up * 0.015f) + (Vector2.right * core.Movement.FacingDirection * 0.015f),
    ...
    private Vector2 DetermineCornerPosition()
    {
        ...
        workspace.Set(core.CollisionSenses.WallCheck.position.x + (xDist * core.Movement.FacingDirection),
