...
public class CollisionSenses : CoreComponent
{
    ...
    public Transform GroundCheck { get => grandCheck; private set => grandCheck = value; }
    ...
    [SerializeField] private Transform grandCheck;
    ...
    {
        get =>  Physics2D.OverlapCircle(grandCheck.position, groundCheckRadius, whatIsGround);
    }
    ...
    public bool Ledge
    {
        get =>  Physics2D.Raycast(ledgeCheck.position, Vector2.right * core.Movement.FacingDirection, wallCheckDistance,
            whatIsGround);
    }
